// SV 시리즈 25팩 메타 — 정가 + 박스 리셀 시세 (메루카리/번개장터 평균 ~2026.05 기준)
// 박스가 = 리셀가 (정가 아님). 정가는 별도 보관 → 차익률 표시용.
...
// 박스 리셀 시세 — JP/KR (엔/원)
// 출처: Mercari 평균(일판), 번개장터/네이버 평균(한판). 변동성 ±20%
export const SET_EXTRAS: Record<string, SetMetaExtra> = {
  SV1V: {
    ...
    nameKR_full: "스칼렛 ex",
    packPriceJPY: 430, boxPriceJPY: 13000, msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2023-01-20",
  },
  SV1S: {
  ...
  SV1a: {
    ...
    nameKR_full: "트리플렛 비트",
    packPriceJPY: 320, boxPriceJPY: 9500, msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2023-03-10",
  },
  SV2D: {
    code: "SV2D", releasedKR: true,
    packPriceKR: 2400, boxPriceKR: 72000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2023-07-21",
    nameKR_full: "클레이 버스트",
    packPriceJPY: 300, boxPriceJPY: 9000, msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2023-04-14",
  },
  SV2P: {
  ...
  SV2a: {
    ...
    packPriceJPY: 2400, boxPriceJPY: 48000, msrpPackJPY: 550, msrpBoxJPY: 11000, releaseJP: "2023-06-16",
  },
  SV3: {
    code: "SV3", releasedKR: true,
    packPriceKR: 4000, boxPriceKR: 120000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2023-10-27",
    nameKR_full: "흑염의 지배자",
    packPriceJPY: 530, boxPriceJPY: 16000, msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2023-07-28",
  },
  SV3a: {
    code: "SV3a", releasedKR: true,
    packPriceKR: 2400, boxPriceKR: 70000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2023-11-24",
    nameKR_full: "레이징 서프",
    packPriceJPY: 280, boxPriceJPY: 8500, msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2023-09-22",
  },
  SV4K: {
    code: "SV4K", releasedKR: true,
    packPriceKR: 2100, boxPriceKR: 62000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2024-01-26",
    nameKR_full: "고대의 포효",
    packPriceJPY: 250, boxPriceJPY: 7500, msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2023-10-27",
  },
  SV4M: {
  ...
  SV4a: {
    ...
    packPriceJPY: 1100, boxPriceJPY: 22000, msrpPackJPY: 550, msrpBoxJPY: 5500, releaseJP: "2023-12-01",
  },
  SV5K: {
    code: "SV5K", releasedKR: true,
    packPriceKR: 2000, boxPriceKR: 58000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2024-04-26",
    nameKR_full: "와일드 포스",
    packPriceJPY: 240, boxPriceJPY: 7000, msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2024-01-26",
  },
  SV5M: {
  ...
  SV5a: {
    ...
    nameKR_full: "크림슨 헤이즈",
    packPriceJPY: 280, boxPriceJPY: 8500, msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2024-03-22",
  },
  SV6: {
    code: "SV6", releasedKR: true,
    packPriceKR: 2100, boxPriceKR: 60000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2024-08-30",
    nameKR_full: "변환의 가면",
    packPriceJPY: 250, boxPriceJPY: 7500, msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2024-04-26",
  },
  SV6a: {
    code: "SV6a", releasedKR: true,
    packPriceKR: 3000, boxPriceKR: 88000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2024-09-27",
    nameKR_full: "나이트 원더러",
    packPriceJPY: 370, boxPriceJPY: 11000, msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2024-06-07",
  },
  SV7: {
    code: "SV7", releasedKR: true,
    packPriceKR: 2300, boxPriceKR: 65000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2024-11-15",
    nameKR_full: "스텔라 미라클",
    packPriceJPY: 270, boxPriceJPY: 8000, msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2024-07-19",
  },
  SV7a: {
    ...
    packPriceJPY: 320, boxPriceJPY: 9500, msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2024-09-13",
  },
  SV8: {
    code: "SV8", releasedKR: true,
    packPriceKR: 2400, boxPriceKR: 70000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2025-02-21",
    nameKR_full: "초전 브레이커",
    packPriceJPY: 290, boxPriceJPY: 8500, msrpPackJPY: 180, msrpBoxJPY: 5400, releaseJP: "2024-10-18",
  },
  SV8a: {
    ...
    packPriceJPY: 800, boxPriceJPY: 16000, msrpPackJPY: 550, msrpBoxJPY: 5500, releaseJP: "2024-12-06",
  },
  SV9: {
    code: "SV9", releasedKR: true,
    packPriceKR: 3200, boxPriceKR: 95000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2025-06-20",
    nameKR_full: "배틀 파트너즈",
    packPriceJPY: 400, boxPriceJPY: 12000, msrpPackJPY: 180, msrpBoxJPY: 5400, releaseJP: "2025-01-24",
  },
  SV9a: {
